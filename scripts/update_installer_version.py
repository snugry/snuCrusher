...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SnuCrusher Demo Installer\n"
      else:
        line="OutputBaseFilename=SnuCrusher Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SnuCrusher Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SnuCrusher installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SnuCrusher Demo installer\n"
     else:
       line="SetupWindowTitle=SnuCrusher installer\n"
