...
def main():
  ...
  plistpath = scriptpath + "/resources/SnuCrusher-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SnuCrusher-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/SnuCrusher-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/SnuCrusher-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/SnuCrusher-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/SnuCrusher.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/SnuCrusher.iss",inplace=1):
